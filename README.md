# ![alt text](https://github.com/dylanlee91/DSI-Ames-Housing/blob/main/ga_logo.png?raw=true)  General Assembly Data Science Immersive Project 2: Using machine learning to predict sale prices of residential property in Ames, Iowa
